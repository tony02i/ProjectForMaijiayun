	...
	$(function(){
		...
		$("#requiretext").blur(function(){
			...
			if(name==""){
				...
				$.get("getbyid",
						{"id":name,"_":new Date().getTime()},function(jsonObject){
							if(jsonObject.success){
								$("#requirespan").text("");
							}else{
    ...
    <div>
        ...
        <br/><br/>
				...
				<form action="save" method="post" id="addform">
					<div >
						<label>&nbsp&nbsp编&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp码:<input name="id" id="requiretext" type="text" class="form-control" id="name" placeholder="请输入编码"><span id="requirespan" style="color: red;font-size: 16px"></span></label>
					</div>
					<div>
						<label>&nbsp&nbsp名&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp称:<input name="name" type="text" class="form-control" id="name" placeholder="请输入名称"></label>
					</div>
					<div >
						<label>&nbsp&nbsp账户类型:&nbsp&nbsp<select name="type" class="select_gallery" style="width:220px;">
					...
					<div>
						<label>&nbsp&nbsp备&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp注:<input name="note" type="text" class="form-control" id="name" placeholder="请填写备注"></label>
					</div>
					<div >
